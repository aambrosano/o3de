...
namespace EMStudio
{
    ...
    public:
        ...
        bool GetIsInsideNodeGroupTitleRect(const EMotionFX::AnimGraphNodeGroup* nodeGroup, const QPoint& globalPoint) const;
        ...
        void HideNodeGroup(EMotionFX::AnimGraphNodeGroup* nodeGroup);
        ...
        GraphNode* FindGraphNode(const EMotionFX::AnimGraphNode* node) const;
